...
Rebuilt and then some more. Obviously not usable, templates as is, especially in regards to security. Want to get an SQL injection, go ahead. Was it worth making it parse and upload 66k+ entries from Rust to SQL in ~4 seconds? Maybe but no.
